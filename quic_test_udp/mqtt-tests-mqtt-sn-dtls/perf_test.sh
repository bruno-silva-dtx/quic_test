...
sudo perf stat -o ./results/tcp/perf-loss-$loss-delay-$delay-n-$number_of_packets-s-$size_of_packets-i-$msg_interval.txt -a -r $runs -e power/energy-cores/,power/energy-gpu/,power/energy-pkg/ ./bin/python3 ./mqtt-client/mqtt-pub.py  -b 127.0.0.1 -t tcp -n $number_of_packets -s $size_of_packets -i $msg_interval

sudo perf stat -o ./results/tls/perf-loss-$loss-delay-$delay-n-$number_of_packets-s-$size_of_packets-i-$msg_interval.txt -a -r $runs -e power/energy-cores/,power/energy-gpu/,power/energy-pkg/ ./bin/python3 ./mqtt-client/mqtt-pub.py  -b 127.0.0.1 -t tls -n $number_of_packets -s $size_of_packets -i $msg_interval

sudo perf stat -o ./results/ws/perf-loss-$loss-delay-$delay-n-$number_of_packets-s-$size_of_packets-i-$msg_interval.txt -a -r $runs -e power/energy-cores/,power/energy-gpu/,power/energy-pkg/ ./bin/python3 ./mqtt-client/mqtt-pub.py  -b 127.0.0.1 -t ws -n $number_of_packets -s $size_of_packets -i $msg_interval

sudo perf stat -o ./results/wss/perf-loss-$loss-delay-$delay-n-$number_of_packets-s-$size_of_packets-i-$msg_interval.txt -a -r $runs -e power/energy-cores/,power/energy-gpu/,power/energy-pkg/ ./bin/python3 ./mqtt-client/mqtt-pub.py  -b 127.0.0.1 -t wss -n $number_of_packets -s $size_of_packets -i $msg_interval
