...
BEGIN {
    ...
    require '/home/dae/quic_test_udp/mqtt-tests-mqtt-sn-dtls/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/dae/quic_test_udp/mqtt-tests-mqtt-sn-dtls/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
